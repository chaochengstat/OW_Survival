...
for (i in (1:20)) {
  dat = data_gen_censor(n=500000,overlap="weak",censor = "50%")
...
for (i in (1:replication)) {
  dat=data_gen_censor(n=2000,overlap="weak",censor = "50%")
...
library(rtf)
rtffile <- RTF("result_weak_50cen.doc")  # this can be an .rtf or a .doc
...
write.csv(myTab,"result_weak_50cen.csv")
