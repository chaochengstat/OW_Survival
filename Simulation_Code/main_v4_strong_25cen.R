...
for (i in (1:20)) {
  dat = data_gen_censor(n=500000,overlap="strong",censor = "25%")
...
for (i in (1:replication)) {
  dat=data_gen_censor(n=2000,overlap="strong",censor = "25%")
...
library(rtf)
rtffile <- RTF("result_strong_25cen.doc")  # this can be an .rtf or a .doc
...
write.csv(myTab,"result_strong_25cen.csv")
