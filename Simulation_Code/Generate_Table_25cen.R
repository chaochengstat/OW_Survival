...
dat1=read.csv("result_strong_25cen.csv")[,-1]
dat2=read.csv("result_medium_25cen.csv")[,-1]
dat3=read.csv("result_weak_25cen.csv")[,-1]
...
rtffile <- RTF("tab_25cen.doc")  # this can be an .rtf or a .doc
